...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { decription: @welcome.decription, link: @welcome.link, logo: @welcome.logo, love: @welcome.love, name: @welcome.name, org: @welcome.org, view: @welcome.view, viewhehe: @welcome.viewhehe }
    end
  ...
  test "should update welcome" do
    patch :update, id: @welcome, welcome: { decription: @welcome.decription, link: @welcome.link, logo: @welcome.logo, love: @welcome.love, name: @welcome.name, org: @welcome.org, view: @welcome.view, viewhehe: @welcome.viewhehe }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
